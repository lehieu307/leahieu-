const contentLetterSrart_actived = "helo lê hiếu đây, đây là 6 tiếng ngồi sửa và fix rất nhiều lỗi để có món quà này để dành tặng bạn đó, mặc dù đơn sơ với không đặc sắc nhưng mà mong bạn có thể nhận nó nhé:3 " //Lời mở đầu cho bức thư
